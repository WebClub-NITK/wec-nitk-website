...
const Card = ({blog,
  ...
  return (
      <div className="h-96 mb-4 grid grid-cols-5 mx-8 max-xs:grid-cols-1 max-xs:h-96 rounded-tl-2xl
      rounded-bl-2xl rounded-tr-2xl rounded-br-2xl
      cursor-pointer dark:bg-gray-800" style={{'width':`${cardWidth}px`}} 
      ...
      >
       ...
       <div className="col-span-3 max-xs:cols-span-1 max-xs:col-span-1 max-xs:h-60 bg-gray-200 dark:bg-gray-800 
        rounded-tr-2xl rounded-br-2xl
       max-xs:rounded-bl-2xl max-xs:rounded-br-2xl max-xs:rounded-tr-none flex flex-col p-4 max-xl:pt-4 dark:text-white">
           <div className="flex flex-row justify-between dark:text-white">
              <div>
                <span className="max-lg:text-sm max-md:text-xs dark:white">{blog.author}</span>
              </div>
              <div>
                <span className="max-lg:text-sm max-md:text-xs font-semibold dark:white">{blog.sig}</span>
              </div>
           </div>
           <div>
           ...
           <div className="pb-3 text-xl max-xl:pb-0 text-pretty max-xl:text-lg max-lg:text-sm max-md:text-lg max-sm:text-md max-xs:text-sm dark:text-white">
              <p>{blog.subheading.slice(0,130)}...</p>
           </div>
           <div className="mt-2">
              <div className="cursor-pointer dark:text-primary-500 font-semibold">
                # {blog.tags}
              </div>
           </div>
       </div>
