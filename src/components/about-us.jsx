...
export function AboutUsSection() {
  return (
    ...
    <div className="flex flex-col lg:px-2 lg:m-2 lg:py-8">
      ...
      <MagicContainer className="mx-auto flex max-w-6xl flex-wrap items-center justify-center gap-6 lg:gap-[72px]">
        <MagicCard className="flex h-72 lg:w-72 w-full md:w-72 flex-col items-center justify-center rounded-3xl bg-comet px-4 py-8 text-center md:px-6 md:py-10 gap-4">
        ...
        <MagicCard className="flex h-72 lg:w-72 w-full md:w-72 flex-col items-center justify-center rounded-3xl bg-soft-blue px-4 py-8 text-center md:px-6 md:py-10 gap-4">
        ...
        <MagicCard className="flex h-72 lg:w-72 w-full md:w-72 flex-col items-center justify-center rounded-3xl bg-nebula px-4 py-8 text-center md:px-6 md:py-10 gap-4">
