export const ourSigsData = [
  {
    id: 1,
    title: (
      <h2 className="font-semibold text-[#DB6541] lg:text-2xl">
        Algorithms Group
      </h2>
    ),
    description:
  ...
  },
  {
    id: 2,
    title: (
      <h2 className="font-semibold text-[#D29080] lg:text-2xl flex gap-[5px]">
        <span className="text-[#EA4234]">Google</span>
        <span className="text-[#4385F8]">Developer</span>
        <span className="text-[#139C59]">Student</span>
        <span className="text-[#FABD06]">Clubs</span>
      </h2>
    ),
    description:
  ...
  },
  {
    id: 3,
    title: (
      <h2 className="font-semibold text-[#BDCC1C] lg:text-2xl">
        Intelligence Group
      </h2>
    ),
    description:
  ...
  },
  {
    id: 4,
    title: (
      <h2 className="font-semibold text-[#F59453] lg:text-2xl">
